...
#elif defined AGNOSTOBOT_CONTROLLER
  //pins for motor encoders
  //only one phase of each motor encoder is currently attached to interrupt capable pins
  //phase B of one motor should be connected to interrupt capable pin since motors are opposite of each other
  #define LEFT_ENCCODER_PIN_A   2
  #define LEFT_ENCCODER_PIN_B   4
  #define RIGHT_ENCCODER_PIN_A  5
  #define RIGHT_ENCCODER_PIN_B  3
#endif
