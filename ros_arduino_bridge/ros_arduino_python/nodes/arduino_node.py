...
from ros_arduino_python.encoder_controller import EncoderController
...
class ArduinoROS():
    def __init__(self):
        ...
        self.use_encoder_controller = rospy.get_param("~use_encoder_controller", False)

        if self.use_base_controller and self.use_encoder_controller:
            rospy.logerr("Error: use_base_controller and use_encoder_controller are both True")
            os._exit(1)
...
#                    self.sensors[len(self.sensors)]['output_pin'] = params['output_pin']
        ...
        # Initialize the encoder controller if used  
        if self.use_encoder_controller:
            self.myEncoderController = EncoderController(self.controller)
